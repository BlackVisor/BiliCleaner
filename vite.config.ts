    ...
    plugins: [
        ...
        monkey({
            ...
            userscript: {
                ...
                license: 'GPL-3.0',
                version: '1.0.0',
                description: 'B站视频中插播广告跳过工具，',
                updateURL: 'https://github.com/BlackVisor/bilicleaner/releases/download/v1.0.0/bilicleaner.user.js', // Release Raw链接
                downloadURL: 'https://github.com/BlackVisor/bilicleaner/releases/download/v1.0.0/bilicleaner.user.js', // 和updateURL一致即可
                match: [
                    'https://*.bilibili.com/video/*',
                    'https://*.bilibili.com/list/watchlater*'
                ],
                exclude: ['https://live.bilibili.com/*'],
                grant: ['GM_xmlhttpRequest', 'unsafeWindow', 'window.onurlchange'],
