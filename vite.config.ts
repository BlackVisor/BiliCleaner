    ...
    plugins: [
        ...
        monkey({
            ...
            userscript: {
                ...
                updateURL: 'https://github.com/BlackVisor/bilicleaner/releases/download/v1.0.1/bilicleaner.user.js', // Release Raw链接
                downloadURL: 'https://github.com/BlackVisor/bilicleaner/releases/download/v1.0.1/bilicleaner.user.js', // 和updateURL一致即可
                match: [
